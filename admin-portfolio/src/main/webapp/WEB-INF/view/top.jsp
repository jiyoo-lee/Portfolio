	...
	<div class="logo_wrap">
		<div class="resp_wrap">
            ...
            <ul class="util_wrap_menu2">
                <li><a href="#" designElement="text" textIndex="4" target="_self">로그인</a></li>
				<li>
					<a href="#" designElement="text" textIndex="5" target="_self">회원가입</a>
				</li>
                <!-- <li><a href="/service/cs" designElement="text">CS CENTER</a></li> -->
                <li class="respCartArea"><a href="#"><em designElement="text" textIndex="6">CART</em></a></li>
