...
<div class="footer_b">
    <div class="resp_wrap">
        <ul class="menu2">
            <li><a href="/service/company" designElement="text" textIndex="1">회사소개</a></li>
            <li><a href="/service/agreement" designElement="text" textIndex="2">이용약관</a></li>
            <li><a href="/service/privacy" designElement="text" textIndex="3"><strong>개인정보처리방침</strong></a></li>
            <li><a href="/service/guide" designElement="text" textIndex="4">이용안내</a></li>
            <li><a href="/service/partnership" designElement="text">제휴안내</a></li>
            <li><a href="/service/cs" designElement="text" textIndex="5">고객센터</a></li>               
        </ul>
    </div>
</div>
<div class="resp_wrap">
        ...
        <li class="footer_b1">
            ...
            <ul class="menu">
                <li class="company_bank">
                    <p class="bank_info"><span designElement="text" textIndex="10"   >HOLDER</span> : 주식회사 0000 / 신한은행 1234-56-413414</p>
                </li>
            </ul>
            <!-- //무통장 입금계좌 -->
        </li>
...
<div class="footer_c">
    <div class="resp_wrap">
        <div class="line">
            ...
            <!-- //회사 정보 -->
            <p class="copyright" designElement="text" textIndex="30"   >COPYRIGHT (c) <strong class="pcolor">인테리어 TRENDY LIVING IDEA</strong>&nbsp; ALL RIGHTS RESERVED.</p>
